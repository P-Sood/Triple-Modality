...
python ../tav_nn.py --fusion "d_c_tv"  --sampler "Weighted"  --loss "CrossEntropy" --seed 3 --beta 1  --clip 0.1  --mask false  --sota false  --T_max 2  --epoch 10  --model "MAE_encoder"   --dataset "../../data/urfunny"  --dropout 0.2   --patience 14  --BertModel "roberta-large"  --early_div false  --input_dim 2  --batch_size 32  --label_task "humour"  --num_layers 6  --output_dim 7  --hidden_size 1536  --lstm_layers 1  --text_column "text"  --epoch_switch 2  --num_encoders 3  --weight_decay 0.01  --hidden_layers 512  --learning_rate 0.0001  --learn_PosEmbeddings false

for i in 4 5
do
    python ../tav_nn.py --fusion "d_c_tv"  --sampler "Both"  --loss "NewCrossEntropy" --seed $i --beta 1  --clip 0.1  --mask false  --sota false  --T_max 2  --epoch 10  --model "MAE_encoder"   --dataset "../../data/urfunny"  --dropout 0.2   --patience 14  --BertModel "roberta-large"  --early_div false  --input_dim 2  --batch_size 32  --label_task "humour"  --num_layers 6  --output_dim 7  --hidden_size 1536  --lstm_layers 1  --text_column "text"  --epoch_switch 2  --num_encoders 3  --weight_decay 0.01  --hidden_layers 512  --learning_rate 0.0001  --learn_PosEmbeddings false
    python ../tav_nn.py --fusion "d_c_tv"  --sampler "Both_NoAccum"  --loss "NewCrossEntropy" --seed $i --beta 1  --clip 0.1  --mask false  --sota false  --T_max 2  --epoch 10  --model "MAE_encoder"   --dataset "../../data/urfunny"  --dropout 0.2   --patience 14  --BertModel "roberta-large"  --early_div false  --input_dim 2  --batch_size 32  --label_task "humour"  --num_layers 6  --output_dim 7  --hidden_size 1536  --lstm_layers 1  --text_column "text"  --epoch_switch 2  --num_encoders 3  --weight_decay 0.01  --hidden_layers 512  --learning_rate 0.0001  --learn_PosEmbeddings false
