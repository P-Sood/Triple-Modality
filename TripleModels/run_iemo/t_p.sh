...
python ../tav_nn.py --seed 104 --LOSS "false" --clip 7.369640730753725 --loss "NewCrossEntropy" --T_max 3 --epoch 12 --fusion "t_p" --dataset "../../data/more_text_IEMO" --dropout 0.38593766147160713 --sampler "Both" --patience 14 --batch_size 24 --label_task "emotion" --num_layers 6 --hidden_size 64 --epoch_switch 3 --num_encoders 2 --weight_decay 0.004826565276096935 --learning_rate 0.000001793036042228087 
