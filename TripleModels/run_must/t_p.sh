...
for i in 101 102 103 104 594
do
    python ../tav_nn.py --clip 0.1 --seed $i --T_max 2 --epoch 10 --fusion "t_p" --dataset "../../data/must" --dropout 0.6 --sampler "Both" --patience 14 --batch_size 24 --early_stop "f1" --label_task "sarcasm" --num_layers 5 --hidden_size 256 --epoch_switch 2 --num_encoders 1 --weight_decay 0.0001 --learning_rate 0.000001
done
