...
def get_statistics(
    ...
    Metric,
    check="train",
    location="/home/prsood/projects/def-whkchun/prsood/multi-modal-emotion/Inference/imageTest.txt",
):
    batch_loss = None
...
def img_train(
    ...
    torch.save(
        model.state_dict(),
        "/home/prsood/projects/def-whkchun/prsood/multi-modal-emotion/Inference/Image.pt",
    )
    return model
